...
static  void  Ex_IdleTask (void  *p_arg)
{
    ...
    while (1)
    {
        OSTimeDly(1000,OS_OPT_TIME_DLY,&err); //1000 os ticks from now
        EMU_EnterEM1();
    }
}
...
static  void  Ex_PHYSICS_Task (void  *p_arg)
{
    ...
    while (1)
    {
        ...
        {
        	physics.v_position = 20;
//        	if (physics.v_position < 20.1)
//        	{
//        		physics.v_position = physics.v_position-0.1;
//        	}
//        	else
//        	{
//        		physics.v_position = 20;
...
static  void  Ex_LCD_Display_Task (void  *p_arg)
{
    ...
    while (1)
    {
    	...
    	else
    	{
			...
			GLIB_drawCircleFilled(&context, x, y, 7);
			Rect.xMax = c+8;
			Rect.xMin = c-8;
			Rect.yMax = 128;
			Rect.yMin = 118;
